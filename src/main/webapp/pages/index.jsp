...
<html>
  ...
  <body class="easyui-layout">  
	<div data-options="region:'north',split:true,border:true" style="height:70px;"class="cs-north">
		<div class="head_a" >
			<div class="head_aa">社会保障卡综合服务平台</div>
			<div class="head_ab" >
			          用户名：<%=vo.getUsername()%>
			          角色：<%=vo.getRolename()%>
    ...
    <div id="mainPanle" data-options="region:'center',border:true,border:false " >
		<div id="tabs" class="easyui-tabs"  fit="true" border="false" >
            <div title="首页">
				<div >
					制作：football98<br>
					说明：jQuery EasyUI 1.3.0
				</div>
			</div>
        </div>
    </div> 
    
    <div data-options="region:'south',split:true,border:false" style="height:25px;background:#EAEEF5;"><center>技术支持:秦皇岛东易科技有限公司</center></div>  
